 ...
 *
 * This file is an implementation of Eigenfaces.
 *
 * Eigenfaces is based on The Principal Component Analysis (PCA) which turns a
 * set of possibly correlated variables into a smaller set of uncorrelated
 * variables. 
 *
 * The idea is, that a high-dimensional dataset is often described by correlated
 * variables and therefore only a few meaningful dimensions account for most of
 * the information.
 * 
